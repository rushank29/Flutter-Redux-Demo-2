...
import 'package:flutter_redux_demo_2/screens/user_details/screen/update_user/update_user_bloc.dart';
...
class _UpdateUserScreenState extends State<UpdateUserScreen> {
  ...
  void didChangeDependencies() {
    _updateUserBloc = UpdateUserBloc(context: context);
            ...
            children: [
                ...
                children: [
                  Expanded(
                    child: StoreConnector<AppState, String>(
                        converter: (store) => '${store.state.formDataState.userDetailsModel.firstName}',
                        builder: (context, firstName) {
                          _updateUserBloc.firstNameController.text = firstName;
                  ...
                  Expanded(
                    child: StoreConnector<AppState, String>(
                        converter: (store) => '${store.state.formDataState.userDetailsModel.lastName}',
                        builder: (context, lastName) {
                          _updateUserBloc.lastNameController.text = lastName;
                          return TextFormField(
              ...
              Row(
                children: [
                  Expanded(
                    flex: 3,
                    child: StoreConnector<AppState, String>(
                        converter: (store) => '${store.state.formDataState.userDetailsModel.age}',
                        builder: (context, age) {
                          _updateUserBloc.ageController.text = age;
                          return TextFormField(
                  ...
                  Expanded(
                    flex: 7,
                    child: StoreConnector<AppState, String>(
                      converter: (store) => '${store.state.formDataState.userDetailsModel.contactNo}',
                      builder: (context, contact) {
                        _updateUserBloc.contactController.text = contact;
                        return TextFormField(
                ...
                child: Column(
                  children: [
                    ...
                    StoreConnector<AppState, String>(
                      converter: (store) => '${store.state.formDataState.userDetailsModel.gender}',
                      builder: (context, gender) {
                        //  if the country value is saved in the redux persist then and only then
                        gender.isNotEmpty ? _updateUserBloc.selectedGender = gender : null;
              ...
              Row(
                children: [
                  Expanded(
                    flex: 2,
                    child: StoreConnector<AppState, String>(
                      converter: (store) => '${store.state.formDataState.userDetailsModel.city}',
                      builder: (context, city) {
                        _updateUserBloc.cityController.text = city;
                        return TextFormField(
                  ...
                  Expanded(
                    flex: 3,
                    child: StoreConnector<AppState, String>(
                      converter: (store) => '${store.state.formDataState.userDetailsModel.country}',
                      builder: (context, country) {
                        //  if the country value is saved in the redux persist then and only then
                        country.isNotEmpty ? _updateUserBloc.getSelectedCountry(country) : null;
              ...
              Container(
                ...
                child: Column(
                  children: [
                    ...
                    StoreConnector<AppState, String>(
                      converter: (store) => '${store.state.formDataState.userDetailsModel.knownLanguages}',
                      builder: (context, language) {
                        _updateUserBloc.setInitialSelectedLanguage(language);
                        return StreamBuilder<List<SelectionModel>>(
              ...
              TextButton(
                ...
                onPressed: () {
                  ...
                  print("firstName =======> ${store.state.formDataState.userDetailsModel.firstName}");
                },
                child: const Text(
                  'Save',
